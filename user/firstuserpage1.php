	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Shop using catagory</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!--- groceries --->
	<div class="products">
       ...
       $stcn = $admin -> ret("SELECT * FROM `addcat`");

      while ($ron= $stcn -> fetch(PDO::FETCH_ASSOC)) {

      ?>
													
								<li ><a href="firstuserpage1.php?ic=<?php echo $ron['cname']; ?>" style="color: black !important"><i class="fa fa-arrow-right" aria-hidden="true"></i><?php echo $ron['cname']; ?></a></li>
			...
			<div class="col-md-8 products-right">
				...
				<div class="agile_top_brands_grids">
					 ...
					 <?php
                 $stmts = $admin -> ret("SELECT * FROM `addsellerproduct` WHERE `cname`='$ic'");
