...
<!-- //navigation -->
        ...
        <div class="col-sm-12">
           ...
           $stmts=$admin -> ret("SELECT * FROM `addsellerproduct` WHERE `cs_id`='$idd'");
   ...
   
            {
               ?>
                  ...
                  <tr>
                         ...
                         <td>
                          <a href="firstsellerpageupdate.php?id=<?= $rowss['p_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to make changes?')"><b><i>Update</i></b></a>
                         </td>
