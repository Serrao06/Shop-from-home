...
$id = $_GET['id'];
$stm = $admin -> ret("SELECT * FROM `addsellerproduct` WHERE `p_id` = '".$id."' AND `cs_id` = '".$cs_id."' ");
...
<div class="col-lg-10" style="color:orange;">
  <form action="usercontroller/firstsellerpage.php" method="post" enctype="multipart/form-data">
    <label for="book name" Style="color:#15b1a2">product name:</label>
    
 
   
                                    <input type="text" class="form-control"  value="<?php echo $ro['name']; ?>" placeholder="Enter product name" name="name">
                                    <br>
...
<label for="book name" Style="color:#15b1a2">select product catagory:</label>
                 ...
                 ?><option value="<?php echo $rows['cname'] ; ?>" ><?php echo $rows['cname']; ?></option>
								...
								<br>
                                    ...
                                    <label for="book name" Style="color:#15b1a2">product image:</label>
                                    <input type="file" class="form-control" placeholder="Enter books image" name="image">
                                    <br>
                                    

                                    <label for="book name" Style="color:#15b1a2">manufacture date:</label>
                                    <input type="text" class="form-control" placeholder="Enter manufacture date" name="aname" value="<?php echo $ro['mdat']; ?>">
                                    <br>
                                    

                                    <label for="book name" Style="color:#15b1a2">expired date:</label>
                                    <input type="text" class="form-control" placeholder="Enter expired date" name="pname" value="<?php echo $ro['edat']; ?>">
                                    <br> 
                                    
                                    <label for="book name" Style="color:#15b1a2">product price:</label>
                                    <input type="text" class="form-control" placeholder="Enter product price" name="price" value="<?php echo $ro['price']; ?>">
                                    <br> 
                                    
                                    <label for="book name" Style="color:#15b1a2">product discount:</label>
                                    <input type="text" class="form-control" placeholder="Enter product discount" name="discount" value="<?php echo $ro['discount']; ?>">
                                    <br> 
                                    
                                    <label for="book name" Style="color:#15b1a2">product quantity:</label>
                                    <input type="text" class="form-control" placeholder="Enter product quantity" name="quantity" value="<?php echo $ro['quantity']; ?>">
                                    <br> 


                                    <label for="book name" Style="color:#15b1a2">product description:</label>
                                    <textarea class="form-control" placeholder="Enter product description" rows="4" name="text"><?php echo $ro['description']; ?></textarea>
                                    <br>


                                      <input type="hidden" value="<?php echo $id ?>" name="id">  
  
    <input type="submit" value="Submit" name="update" Style="color:#15b1a2; font-weight:700">
  </form>
</div>
