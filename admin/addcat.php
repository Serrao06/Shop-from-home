              ...
              <div class="panel-body">
                <form action="admincontroller/addcat.php" method="POST">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter your category" name="cat">
                  </div>
                  
                
                  <button type="submit" class="btn btn" name="add" style="background-color: #15b1a2;color: white">ADD</button>
                </form>
